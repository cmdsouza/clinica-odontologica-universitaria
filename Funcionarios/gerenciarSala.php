					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Gerenciar Consultório</h2>
								<p class="text-white">Cadastre ou Altere os Consultórios Disponíveis para Consultas</p>
							</div>							
						</div>
					</div>
				</div>
					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-11 col-md-12 mt-sm-30">
								<div class=" mt-30"> 
									<form method='POST' action='inserirSala.php'>
										<h3 class="mb-30">Cadastrar Novo Consultório</h3>
										<div class='mt-10'>
											<input type='text' name='nome' placeholder='Nome do Consultório' onfocus='this.placeholder = ''' onblur='this.placeholder = 'Nome do Consultório'' required class='single-input'>
										</div>
										<div class='mt-10'>
											<input type='number' name='andar' placeholder='Andar' onfocus='this.placeholder = ''' onblur='this.placeholder = 'Andar'' required class='single-input' min='1' max='4'>
										</div>
				...
				<div class="container">					
					<div class="row">
						<?php
							...
							while($contadorPeriodo != 4){
									echo "
										<div class='col-lg-4'>
											<div class='single-price no-padding'>
												<div class='price-top'>
													<h4>".$contadorPeriodo."º Andar</h4>
												</div>
												<ul class='lists'>
									";
									
									$sqlNome = "SELECT * FROM tb_sala WHERE nr_andar = ".$contadorPeriodo;
									$resultadoNome = mysql_query($sqlNome) or die();
									while($linhaNome = mysql_fetch_array($resultadoNome)){
										echo "<li><b>".$linhaNome['nm_nomeSala']."</b></li>";
									}

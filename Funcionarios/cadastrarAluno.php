...
?>
	...
	<head>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Cadastrar um Novo Aluno</h2>
								<p class="text-white">Dados Pessoais</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<style>
			...
			if(isset($_SESSION['mensagem']) && ($_SESSION['mensagem'] == "Aluno Cadastrado")){	
				echo "
					<div class='alert alert-success alert-dismissible fade show' style='z-index: 5; position: fixed; top: 9%; right: 0; left: 2%; width:50%' role='alert' id='fadeout'>
					  <strong>Sucesso!</strong> ".$_SESSION['mensagem']."! ID gerado: ".$_SESSION['mensagem2']."
			...
			if(isset($_SESSION['mensagem']) && ($_SESSION['mensagem'] == "Aluno Deletado")){	
				echo "
					<div class='alert alert-success alert-dismissible fade show' style='z-index: 5; position: fixed; top: 9%; right: 0; left: 2%; width:50%' role='alert' id='fadeout'>
		...
		<!-- Start Align Area -->
					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-10 col-md-10">
								...
								<form action="inserirAluno.php" method='POST' enctype="multipart/form-data">
									<div class="mt-10">
									...
									<div class="mt-10">
										<input type="file" name="imagem"  required class="single-input">
									</div>
									<div class="mt-10">
										<input type="password" name="senha" placeholder="Senha  (12345678)" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Senha (12345678)'" class="single-input" disabled>
									</div>
									<div class="mt-10">
									...
									<div class="mt-10">
										<input type="number" name="periodo" placeholder="Período Atual" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Período Atual'" required class="single-input" min='1' max='10'>
									</div>
									<div class="mt-10">
										<input type="text" name="turma" placeholder="Turma" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Turma'" required class="single-input">
									</div>
							</div>
						</div>
			...
			<hr>
			<center><h3>Alunos Cadastrados</h3></center>
			<br>
			...
			<center>
				...
				<?php
								...
								$sqlEnd2 = "SELECT * FROM tb_aluno ORDER BY nr_periodo";
								...
								if($numImg != 0){
										while($linhaEnd2 = mysql_fetch_array($resultadoEnd2)){
											...
											echo "									
												<tr style='background-color:".$color.";'>
													<td><center>".$linhaEnd2['nr_cpfAluno']."</center></td>
													<td><center>".$linhaEnd2['nm_nomeAluno']."</center></td>
													<td><center>".$linhaEnd2['nm_emailAluno']."</center></td>
													<td><center>".$linhaEnd2['nr_periodo']."</center></td>
													<td><center>".$linhaEnd2['nm_turma']."</center></td>
													<td><center><a href='../Alunos/alunos/".$linhaEnd2['nm_foto']."' target='_blank'>Clique aqui</a></center></td>
													<td><center><button class='genric-btn primary' data-toggle='modal' data-target='#ExemploModalCentralizado".$linhaEnd2['nr_cpfAluno']."'>Alterar Dados</button></center></td>
													<!--<td><center><a href='deletarAluno.php?cpf=".$linhaEnd2['nr_cpfAluno']."'><img src='icones/delete.png' data-toggle='popover' data-trigger='hover' data-placement='right' data-content='Deletar!'></a></center></td>-->
												</tr>		
												
											<!-- Modal -->
												<div class='modal fade' id='ExemploModalCentralizado".$linhaEnd2['nr_cpfAluno']."' tabindex='-1' role='dialog' aria-labelledby='TituloModalCentralizado' aria-hidden='true'>
													...
													<div class='modal-content'>
													  ...
													  <div class='modal-body'>
														<form method='POST' action='atualizarAluno.php' enctype='multipart/form-data'>
															<input type='hidden' name='cpf' value='".$linhaEnd2['nr_cpfAluno']."'>
															<b>Nome: </b><input type='text' name='nome' value='".$linhaEnd2['nm_nomeAluno']."' class='single-input'><br>
															<b>E-mail: </b><input type='text' name='email' value='".$linhaEnd2['nm_emailAluno']."' class='single-input'><br>
															<b>Turma: </b><input type='text' name='turma' value='".$linhaEnd2['nm_turma']."' class='single-input'><br>
															<b>Foto: </b><input type='file' name='imagem' class='single-input'>
															
													  </div>
													  <div class='modal-footer'>
														<a class='btn btn-secondary' href='resetarSenha.php?cpf=".$linhaEnd2['nr_cpfAluno']."&tipo=aluno'>Resetar Senha (p/ 12345678)</a>
										...
										echo "<p>Não há alunos cadastrados!</p>";
									}
							?>		
				</table>
			</center>

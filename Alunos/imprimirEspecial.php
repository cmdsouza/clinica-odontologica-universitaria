...
$dompdf = new DOMPDF();
	...
	<center><h2>NOTIFICAÇÃO DE RECEITA DE CONTROLE ESPECIAL</h2></center>
	<p align='right' style='font-size:15px; line-height:0.5;'>1ª VIA FARMÁCIA</p>
	<p align='right' style='font-size:15px;'>2ª VIA PACIENTE</p>
	...
	<br><br>".$_GET['txtArtigo']."<br><br>
	
	<center><img src='icones/especial.png'></center>
	<br>

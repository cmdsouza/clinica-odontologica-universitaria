					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								<p class='text-white'>Preencha as Informações Complementares da Declaração de Comparecimento e Realize a Impressão!</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">		
					...
					<center>
					<form method='POST' action='imprimirComparecimento.php'>
						...
						<table border=0 width='80%' style='color:black;'>
							...
							<tr>
								...
								<td width='40%'><input type='radio' name='fim' value='trabalhistas'> &nbsp; trabalhistas</td>
							</tr>
							<tr>
								<td width='40%'></td>
								<td width='40%'><input type='radio' name='fim' value='escolares'> &nbsp; escolares</td>
							</tr>
							<tr>
								<td width='40%'></td>
								<td width='40%'><input type='radio' name='fim' value='desportivos'> &nbsp; desportivos</td>
							</tr>	
							<tr>
								<td width='40%'></td>
								<td width='40%'><input type='radio' name='fim' value='judiciais'> &nbsp; judiciais</td>
							</tr>
							<tr>
								<td width='40%'></td>
								<td width='40%'><input type='radio' name='fim' value='militares'> &nbsp; militares</td>
							</tr>
							<tr>
								<td>

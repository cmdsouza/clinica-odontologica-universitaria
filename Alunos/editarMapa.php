	...
	<head>
		...
		<body>
		  ...
		  <header id="header" id="home">
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Atualize as Cirúrgias e <br>os Procedimentos de Endodontia</h2>
							</div>							
						</div>
					</div>
				</div>
			...
			if(isset($_SESSION['mensagem']) && ($_SESSION['mensagem'] == "Já foram marcadas 4 procedimentos no período escolhido")){	
				echo "
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">		
					<h3>Atualize as Informações:</h3><br>
							...
							<tr>
								...
								<td>
									<center>
										...
										if($procedimento == 'Procedimento Cirúrgico'){
											echo "

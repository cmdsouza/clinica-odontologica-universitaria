					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h2 class="text-white">Planos de Tratamento</h2>
								<p class="text-white">Solicite e Controle a Aprovação dos Planos de Tratamento Criados</p>
							</div>							
						</div>
					</div>
				</div>
					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-12 col-md-6">
								<h3 class="mb-30">Planos de Tratamento Aguardando Aprovação</h3>
					...
					<div class="section-top-border">
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<h3 class="mb-30">Planos de Tratamento Aprovados</h3>
								<form action="" method='POST'>

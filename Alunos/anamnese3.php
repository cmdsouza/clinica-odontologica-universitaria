  ...
  background-color: #4CAF50;
							...
							<div class="generic-banner-content">
								<?php
									if($sexo == 'Masculino'){
										...
										echo "<p style='color:white;'>A segunda parte já está salva!</p>";
	...
	<?php
				...
				<div class='container'>
					<div class='section'>
						<div class='row'>
							...
							<form method='POST' action='inserirAnamneseTerceiraParte.php'>
			";
			...
			<table border="0">
				<tbody>
				  <tr>
					<td width='130px'><center><input type="checkbox" value="Nao Aferido" name='51a'>Não Aferido</center></td>
					<td width='300px' style='padding-left:20px;'><center><input type="number" class='single-input' placeholder='bpm' name='51b'>bpm</center></td>
			...
			<table border="0">
				<tbody>
				  <tr>
					<td width='130px'><center><input type="checkbox" value="Nao Aferido" name='52a'>Não Aferido</center></td>
					<td width='300px' style='padding-left:20px;'><center><input type="text" class='single-input' placeholder='__/__' name='52b'>mm/Hg</center></td>
			...
			<table border="0">
				<tbody>
				  <tr>
					<td width='130px'><center><input type="checkbox" value="Nao Aferido" name='53a'>Não Aferido</center></td>
					<td width='300px' style='padding-left:20px;'><center><input type="number" class='single-input'placeholder='ºC' name='53b'>ºC</center></td>
			...
			<table border="0">
				<tbody>
				  <tr>
					<td width='130px'><center><input type="checkbox" value="Nao Aferido" name='54a'>Não Aferido</center></td>
					<td width='300px' style='padding-left:20px;'><center><input type="number" class='single-input'placeholder='/min' name='54b'>/min</center></td>

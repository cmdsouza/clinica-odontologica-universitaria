					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								?>
								<p class='text-white'>Aprovar o Tratamento</p>
							</div>							
						</div>
					</div>
				</div>
			...
			<section class="price-area " id="price" style='margin-top:-20px;'>
				...
				<?php	
					echo "
						...
						<input type='hidden' name='tratamento' value='".$_GET['tratamento']."'>
						<input type='text' name='login' placeholder = 'ID' required class='single-input'><br>
						<input type='password' name='senha' placeholder = 'Senha' required class='single-input'><br>

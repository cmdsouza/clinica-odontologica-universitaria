	...
	<head>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								<p class='text-white'>Preencha as Orientações Pós-Operatórias e Realize a Impressão!</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">		
					<h4>Finalize o Preenchimento das Orientações Pós-Operatórias:</h4><br>
					<form method='GET' action='imprimirOrientacoes.php'>
						<input type='hidden' name='cpf' value='<?php echo $_GET['cpf']; ?>'>
						
						<b>1.</b>	Não faça força física nem tome sol nos próximos três dias;<br>
						<b>2.</b>	Mantenha a cabeça elevada ao se deitar;<br>
						<b>3.</b>	Evite cuspir;<br>
						<b>4.</b>	Não faça bochechos;<br>
						<b>5.</b>	Coloque gelo por 48 horas no local da cirurgia (lado de fora da pele), proteja a pele;<br>
						<b>6.</b>	Escovar os dentes pelo menos três vezes ao dia;<br>
						<b>7.</b>	Usar os remédios indicados;<br>
						<b>8.</b>	Em caso de sangramento intenso, procurar o Pronto Socorro Odontológico;<br>
						<table>
							<tr>
								<td><b>9.</b>	Retornar dia</td><td><input type='date' name='data' class="single-input"><td/><td> às</td><td> <input type='text' name='hora' class="single-input"></td><td>, para remoção dos pontos e controle pós-operatório.</td>
							</tr>
						</table>
						
						<br>
						<center><input type='submit' value='Finalizar e Imprimir' class='genric-btn primary'></center>
					</form>
				</div>
			</section>

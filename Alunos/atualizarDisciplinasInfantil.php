...
$sqlDisc = "SELECT * FROM tb_odontogramainfantil WHERE nr_cpfPaciente ='".$_POST['cpf']."'";
...
if($_POST['acao'] == 'adicionar'){
	...
	$sql = "UPDATE `tb_odontogramainfantil` SET `nm_disciplina`='".$disciplinaNova."' WHERE `nr_cpfPaciente` ='".$_POST['cpf']."'";
...
if($_POST['acao'] == 'excluir'){
	...
	if($b == 0){
		...
		echo $sql = "UPDATE `tb_odontogramainfantil` SET `nm_disciplina`='".$comma_separated."' WHERE `nr_cpfPaciente` ='".$_POST['cpf']."'";
		$resultado = mysql_query($sql) or die(mysql_error());

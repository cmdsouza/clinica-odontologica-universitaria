...
.step.finish {
  background-color: #4CAF50;
							...
							<div class="generic-banner-content">
								<?php
									if($sexo == 'Masculino'){
										...
										echo "<p style='color:white;'>Está quase no final!</p>";
	...
	<?php
				...
				<div class='container'>
					<div class='section'>
						<div class='row'>
							...
							<form method='POST' action='inserirAnamneseQuartaParte.php'>
			";
				...
				<tbody>
				  ...
				  <tr>
					<td><center>
						<table border=0>
							<tr>
								<td width='100px'><center><input type="checkbox" value="Assimetria" name='55a'>Assimetria</center></td>
								<td width='165px'><center><input type="checkbox" value="Alteracoes na pele" name='55b'>Alterações na pele</center></td>
								<td width='270px'><center><input type="checkbox" value="Alteracoes em anexos cutaneos" name='55c'>Alterações em anexos cutâneos</center></td>
							</tr>
						</table></center>
					</td>
				  </tr>
			...
			<table border="0" width='100%'>
				<tbody>
					...
					<td colspan=2>
						<center>
							<table border=0 style='margin-bottom:-25px;'>
								<tr>
									<td width='100px;'><br><center><input type="checkbox" value="Bucinador" name='56a'>Bucinador</center><br></td>
									<td width='145px;'><br><center><input type="checkbox" value="Submentoniana" name='56b'>Submentoniana</center><br></td>
									<td width='140px;'><br><center><input type="checkbox" value="Submandibular" name='56c'>Submandibular</center><br></td>
									<td width='90px;'><br><center><input type="checkbox" value="Cervicais" name='56d'>Cervicais</center><br></td>
									<td width='90px;'><br><center><input type="checkbox" value="Parotidea" name='56e'>Parotídea</center><br></td>
									<td width='100px;'><br><center><input type="checkbox" value="Mastoidea" name='56f'>Mastóidea</center><br></td>
									<td width='90px;'><br><center><input type="checkbox" value="Occipital" name='56g'>Occipital</center><br></td>
								</tr>
							</table>
						</center>
					</td>
				  ...
				  <tr>
					...
					<td><br><input type="text" class='single-input' placeholder='Tipo de Comprometimento' name='56i'></td>
				  </tr>
				 </tbody>
			</table>
				...
				<tbody>
				  ...
				  <tr>
					<td colspan=2>
						<table width='100%'>
							<tr>
								<td><br><center><input type="checkbox" value="Parotida" name='57a'>Parótida</center><br></td>
								<td><br><center><input type="checkbox" value="Submandibular" name='57b'>Submandibular</center><br></td>
								<td><br><center><input type="checkbox" value="Sublingual" name='57c'>Sublingual</center><br></td>
							</tr>
						</table>
					</td>
				  </tr>
				  <tr>
					...
					<td colspan='2'><input type="text" class='single-input' placeholder='Tipo de Comprometimento' name='57e'></td>
				  </tr>
				 </tbody>
			</table>
			...
			<!--
			<hr>
			<b>Exame da saliva: Normal?</b>
			<table border="0" width='100%'>
				<tbody>
				  <tr>
					<div class='mt-10'>
						<select class='single-input' name='58'>
							<option value='Nao'>Não</option>
							<option value='Sim'>Sim</option>
						</select>
					</div>
				  ...
				  <tr>
					<td><br><center><input type="checkbox" value="Muito Fluida" name='58a'>Muito Fluida</center><br></td>
					<td><br><center><input type="checkbox" value="Viscosa" name='58b'>Viscosa</center><br></td>
					<td><br><center><input type="checkbox" value="Com pus" name='58c'>Com pus</center><br></td>
					<td><br><center><input type="checkbox" value="Com sangue" name='58d'>Com sangue</center><br></td>
				  </tr>
				  <tr>
					<td colspan='4'><input type="text" class='single-input' placeholder='Outra Alteração' name='58e'></td>
				  </tr>
				 </tbody>
			</table>
			-->
			...
			<table border="0" width='100%'>
				<tbody>
				  ...
				  <tr>
					<td colspan='4'><input type="text" class='single-input' placeholder='Quando?' name='60a'></td>
				  </tr>
				 </tbody>
			</table>

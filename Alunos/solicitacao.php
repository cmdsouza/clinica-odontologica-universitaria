	...
	<head>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								<p class='text-white'>Preencha a Solcitiação de Exames e Realize a Impressão!</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">		
					<h4>Preencha no campo abaixo:</h4><br>
					<center>
					<form method='GET' action='imprimirSolicitacao.php'>

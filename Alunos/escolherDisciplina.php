	...
	<head>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								<p class="text-white">Inclua ou Edite as Disciplinas Associadas ao Odontograma <?php echo $_GET['semestre']; ?>.</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">
				<?php
					$sqlDisc = "SELECT * FROM tb_odontograma WHERE nr_cpfPaciente ='".$_GET['cpf']."' AND nr_periodo = '".$_GET['semestre']."' AND nm_disciplina != '' LIMIT 1";
				...
				?>
					...
					<h3>Disciplinas Associadas: <?php echo $disciplinas; ?></h3><br>
						<form method='POST' action='atualizarDisciplinas.php'>
							<input type='hidden' value='<?php echo $_GET['cpf']; ?>' name='cpf'>
							<input type='hidden' value='<?php echo $_GET['semestre']; ?>' name='semestre'>
							...
							<input type='submit' class="genric-btn primary" value='Atualizar Odontograma'>
							<a href='odontograma.php?cpf=<?php echo $_GET['cpf']; ?>&semestre=<?php echo $_GET['semestre']; ?>' class="genric-btn primary">Voltar</a>
						</form>		

	...
	<head>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								...
								<p class="text-white">Inclua ou Edite as Disciplinas Associadas ao Odontograma Infantil.</p>
							</div>							
						</div>
					</div>
				</div>
		...
		<!-- Start price Area --><br>
			<section class="price-area " id="price">
				<div class="container">
				<?php
					$sqlDisc = "SELECT * FROM tb_odontogramainfantil WHERE nr_cpfPaciente ='".$_GET['cpf']."' AND nm_disciplina != '' LIMIT 1";
				...
				?>
					...
					<h3>Disciplinas Associadas: <?php echo $disciplinas; ?></h3><br>
						<form method='POST' action='atualizarDisciplinasInfantil.php'>
